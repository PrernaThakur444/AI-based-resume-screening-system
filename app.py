...
#             percentage = str(row["Percentage"]).strip()
...
#         st.session_state.required_skills = required_skills_input
...
#             st.session_state.uploaded_resume_data = uploaded_files
...
#         uploaded_files = st.session_state.uploaded_resume_data
...
#                 # ======================================
#                 # CLEAN TECHNICAL SKILL EXTRACTION
#                 # ======================================
